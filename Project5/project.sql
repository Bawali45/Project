-- Active: 1681585334484@@127.0.0.1@3306
...
insert into officelogin values('harsh','2101079');

insert into officelogin values('abhishek10','2101010'),('abhishek11','2101011'),('bittu','2101055');

INSERT INTO Admin (username,password) values('harsh','2101079'),('abhishek10','2101010'),('abhishek11','2101011'),('bittu','2101055');
INSERT INTO office VALUES(125,'Assam','Guwahati','780001','8853569686','harsh@gmail.com','www.Elit properties.com');
...
INSERT INTO agentlogin (agent_id,username, password) 
VALUES 
    (1,'@Amit', 'Amit01'), 
    (2,'@Neha', 'Neha02'), 
    (3,'@Rajesh', 'Rajesh03'), 
...
BEGIN
  UPDATE properties
  SET status = 'sold'
  WHERE pid = NEW.pid and status='sell';
END;

CREATE TRIGGER update_property_rented
AFTER INSERT  ON transaction
FOR EACH ROW
BEGIN
  UPDATE properties
  SET status = 'rented' 
  WHERE pid = NEW.pid and status='rent' ;
END;
...
CREATE TABLE Contactinfo(name VARCHAR(50),email VARCHAR(50),phoneno VARCHAR(12),message VARCHAR (256));



UPDATE properties set year_of_listing=2020 WHERE pid=12;

UPDATE properties set year_of_listing=2021 WHERE pid=40;

UPDATE properties set year_of_listing=2019 WHERE pid=34;
